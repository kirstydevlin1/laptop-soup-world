  ...
  <>
    <Divider speed={0.2} offset={offset}>
      <UpDown>
        ...
        <SVG icon="hexa" width={8} stroke={colors.red} left="60%" top="70%" />
      ...
      <UpDownWide>
        ...
        <SVG icon="triangle" width={14} stroke={colors.pink} left="30%" top="20%" />
        ...
        <SVG icon="circle" width={6} fill={colors['pink-light']} left="75%" top="10%" />
      ...
      <SVG icon="circle" width={64} fill={colors.green} left="90%" top="5%" />
      ...
      <SVG icon="hexa" width={12} stroke={colors['grey-darker']} left="10%" top="50%" />
